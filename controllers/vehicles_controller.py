...
def get_all_vehicles(db: Session, query_params: Optional[VehicleQuery] ):
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Exception occured while getting vehicles"
        )
...
def get_vehicle(db:Session, vehicle_id:int):
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Exception occured while getting vehicle"
        )
...
def update_vehicle(db: Session, vehicle_id: int, request: VehicleQuery):
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Exception occured while updating vehicle"
        )
...
def delete_vehicle(db:Session, vehicle_id:int):
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Exception occured while deleting vehicle"
        )
